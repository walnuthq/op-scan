import { type Hash, type Address, type Hex, type TransactionType } from "viem";
import {
  Prisma,
  PrismaClient,
  type Erc20Token as PrismaErc20Token,
  type Erc721Token as PrismaErc721Token,
  type Erc1155Token as PrismaErc1155Token,
